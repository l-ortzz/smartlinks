    ...
    if (__VLS_ctx.user) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [user, user, user, publicCompanyUrl, logout, error, error, notice, notice, currentView, dashboardTab,];
                } },
            type: "button",
            ...{ class: "sidebar-item" },
            ...{ class: ({
            ...
            for (const [product] of __VLS_vFor((__VLS_ctx.products))) {
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                    ...{ onClick: (...[$event]) => {
                            ...
                            // @ts-ignore
                            [user, user, publicCompanyUrl, dashboardTab, dashboardTab, dashboardTab, dashboardTab, dashboardTab, dashboardTab, products, products, createProduct, productForm, productForm, productForm, productForm, productForm, productForm, productForm, loading, formatCurrency, copyProductLink,];
                        } },
                    type: "button",
                    ...{ class: "ghost-button" },
                });
...
if (__VLS_ctx.currentView === 'company' && __VLS_ctx.company) {
    ...
    for (const [product] of __VLS_vFor((__VLS_ctx.filteredProducts))) {
        ...
        // @ts-ignore
        [currentView, dashboardTab, loading, formatCurrency, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, companyForm, saveCompany, uploadCompanyLogo, uploadingLogo, company, company, company, company, company, company, company, company, company, company, productSearch, filteredProducts,];
    }
}
